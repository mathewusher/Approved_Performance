...
class DmbPartNumbers(models.Model):
    ...
    class Meta:
        ...
        verbose_name_plural="DMB_Part_Numbers"

class FullCatalogFitment(models.Model):
    id = models.CharField(db_column='ID', max_length=5, blank=True, primary_key=True) # Field name made lowercase.
...
class Orders(models.Model):
    ...
    #account_number = models.ForeignKey('MfgToAccountNumber')
